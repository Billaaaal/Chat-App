...
export default function App() {
  ...
  return (
    ...
    <TextInput style={{width:380, height:50, backgroundColor:"#EFEFEF", borderRadius:15, marginBottom:5, left:5}}   onChangeText={(text) => setTextFromInput(text)} onSubmitEditing={()=>{storeHighScore(TextFromDialog, TextFromInput)}}></TextInput>
